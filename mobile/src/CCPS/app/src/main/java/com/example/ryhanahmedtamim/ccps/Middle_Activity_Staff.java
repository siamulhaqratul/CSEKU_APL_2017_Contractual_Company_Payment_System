...
public class Middle_Activity_Staff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        approvedButton = (Button) findViewById(R.id.approvedDutyOfStuffButton);
       ...
       final String contractId = getIntent().getStringExtra("id");
        ...
        approvedButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Middle_Activity_Staff.this,ApprovedDutyOfStaffActivity.class);
                intent.putExtra("id",contractId);
                startActivity(intent);
